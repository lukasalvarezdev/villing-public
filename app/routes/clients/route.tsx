...
export const meta: MetaFunction = () => [{ title: `Clientes - Villing` }];
		...
		<PageWrapper>
			...
			<div className="flex gap-4 flex-col md:flex-row justify-between md:items-end mb-4">
				...
				<div className="flex gap-4">
					<LinkButton to="import" className="flex" variant="secondary">
						...
						{clients.map(client => (
							<TableRow key={client.id}>
								...
								<td>
									...
									>
										<span className="group-hover:underline">Ver cliente</span>
